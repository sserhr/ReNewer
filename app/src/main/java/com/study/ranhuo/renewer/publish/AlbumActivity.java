...
import com.study.ranhuo.renewer.adapter.AlbumGridViewAdapter;
import com.study.ranhuo.renewer.util.AlbumHelper;
import com.study.ranhuo.renewer.util.Bimp;
import com.study.ranhuo.renewer.util.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v("hr", "Album Activity is onCreate");
        init();
		initListener();
