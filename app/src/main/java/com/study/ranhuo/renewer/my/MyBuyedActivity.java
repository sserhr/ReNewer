 ...
 */
public class MyBuyedActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mypublish.whereEqualTo("Buyer", AVUser.getCurrentUser());
...
//                        Log.d("hrPublish", "Price: " + avele.getList("Price").get(0));
    ...
    public void init(){
        ...
        mContext = this;
        goodsShow_lv = (ListView) findViewById(R.id.my_buy_display_lv);
    }
}
